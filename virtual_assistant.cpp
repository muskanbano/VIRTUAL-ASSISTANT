        ...
        if(strcmp(password, "inertia")==0){
            ...
            do{
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    ...
                    cout<<"Good Bye sir/ma'am, have a nice day!!!!"<<endl;
                    string phrase = "Good Bye sir/ma'am, have a nice day";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
                    ...
                    cout<<"I'm a virtual assistant created by my master MUSKAN BANO!!!"<<endl;
                    string phrase = "I am a virtual assistant created by my master MUSKAN BANO";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
